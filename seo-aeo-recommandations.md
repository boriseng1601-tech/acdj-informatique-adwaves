...
| `/a-propos/` | Crédibilité + marque | « ACDJ Informatique » / « Jeason » | ACDJ Informatique | dépanneur informatique Vittel, informaticien indépendant Vosges | — | — | Moyenne | Page E-E-A-T : verrouille la marque (« acdj » pos. 6,79 dans GSC). |
...
**Objectif actuel** : présenter Jeason, les prestations phares, les tarifs, la zone, les avis, et déclencher l'appel. La page est déjà bien construite pour la conversion.
...
**Meta description recommandée** : `Jeason répare vos ordinateurs et téléphones à domicile à Vittel, Contrexéville et dans l'ouest des Vosges. Diagnostic gratuit, prix annoncé avant l'intervention. ☎ 06 52 24 66 47.`
...
**Objectif actuel** : présenter Jeason. **Problème principal** : H1 sans marque ni ville (« Le dépanneur informatique de votre secteur ») alors que cette page doit verrouiller la requête marque « acdj » (pos. 6,79 dans GSC) ; peu de faits vérifiables (depuis quand, statut, formation, nombre d'interventions).

**Mot-clé principal** : `ACDJ Informatique` (marque). **Secondaires** : Jeason, dépanneur informatique Vittel, informaticien indépendant Vosges.
...
**Title** : `À propos — Jeason, dépanneur informatique à Vittel (ACDJ Informatique)`
**Meta description** : `Jeason, fondateur d'ACDJ Informatique : dépannage et assistance à domicile à Vittel, Contrexéville et dans l'ouest des Vosges. Diagnostic gratuit, explications simples, 32 avis Google 5/5.`
**H1** : `Jeason, votre dépanneur informatique à Vittel et dans l'ouest des Vosges`
...
**Meta description** : `Appelez Jeason au 06 52 24 66 47 (lun–ven) ou écrivez à contact@acdj-informatique.com. Dépannage informatique à domicile à Vittel, Contrexéville et dans l'ouest des Vosges.`
...
| **Alt text images** | Présents mais génériques (« Jeason en intervention ») ; seulement 3 images sur tout le site | Alt descriptifs et localisés ; ajouter des photos réelles (interventions, atelier, villes) — un site services sans images locales est un signal faible | Moyenne | `alt="Jeason, dépanneur informatique ACDJ, en intervention à domicile à Vittel"` |
...
| **Open Graph / réseaux** | Absent | Ajouter og:title, og:description, og:image (photo de Jeason) sur les pages principales : améliore les partages et certains crawlers IA | Basse | — |
...
```json
{
  ...
  "founder": { "@type": "Person", "name": "Jeason" },
