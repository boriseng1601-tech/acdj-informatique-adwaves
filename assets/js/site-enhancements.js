...
(function(){
  ...
  function makePopup(){
    ...
    var corporatePage=document.body&&document.body.classList.contains('service-page-network');
    var popupSubtitle=corporatePage?'ACDJ Informatique vous r&eacute;pond directement':'Je vous r&eacute;ponds directement';
    var popupMessage=corporatePage?'Votre message est transmis &agrave; ACDJ Informatique. D&eacute;crivez le besoin, nous vous rappelons d&egrave;s que possible.':'Votre message arrive sur mon t&eacute;l&eacute;phone. D&eacute;crivez le souci, je vous rappelle d&egrave;s que je suis disponible.';
    var consentText=corporatePage?'Vous acceptez d&apos;&ecirc;tre recontact&eacute; par t&eacute;l&eacute;phone ou e-mail pour cette demande.':'J&apos;accepte d&apos;&ecirc;tre recontact&eacute; par t&eacute;l&eacute;phone ou e-mail pour cette demande.';
